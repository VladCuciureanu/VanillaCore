...
extern unsigned short rank_points_from_monsters;
extern unsigned short rank_points_from_monsters_c;
extern int rank_points_penalty;
extern int rank_points_group_penalty;
extern unsigned short rank_points_floor_initial;
extern unsigned short rank_points_floor_initial_c;
extern bool race_5_enable;
extern unsigned int interrupt_interval;
extern bool elevation_enable;
extern bool elevation_use_key;
extern std::string ElevationKey;
extern char s_pepper[16];
extern std::string mysql_pass_func;
extern bool unify_enable;
