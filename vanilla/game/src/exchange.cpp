...
bool CExchange::CheckSpace()
{
	...
	static CGrid s_grid1(5, inventorysize/5 / 2); // inven page 1
	static CGrid s_grid2(5, inventorysize/5 / 2); // inven page 2
	static CGrid s_grid3(5, inventorysize/5 / 2); // inven page 1
	static CGrid s_grid4(5, inventorysize/5 / 2); // inven page 2
	...
	if(!bigger_inventory)
	{
		...
		for (i = 90 / 2; i < 90; ++i)
		{
			...
			s_grid2.Put(i - 90 / 2, 1, item->GetSize());
		}
	} else {
